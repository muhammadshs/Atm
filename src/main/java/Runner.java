       ...
       /* User[] users = new User[1];
        ...
        for (User user : users) {
            if (userName.equals(user.getUserName()) && password == user.getPass()) {
                ...
                System.out.println("4-" + Menu.objects.Transaction);
                ...
                switch (a) {
                    ...
                    case 2:
                        ...
                        user.getAcc().setTransaction(new objects.Transaction(UI.TypeTransaction.withdraw,withDraw, LocalDateTime.now()));
                        System.out.println("******************");
                        System.out.println("Your Balance:"+user.getAcc().getBalance());
                        break;
                    case 3:
                        ...
                        user.getAcc().setTransaction(new objects.Transaction(UI.TypeTransaction.deposit,dep,LocalDateTime.now()));
                        System.out.println("******************");
                        System.out.println("Your Balance:"+user.getAcc().getBalance());
                        break;
                    case 4:
                        System.out.println("Last 10 objects.Transaction:");
                        ArrayList<objects.Transaction> ar=user.getAcc().getListTransaction();
                        int x=0;
                        if(ar.size()>10){
                            x=10;
                        }else{
                        ...
                        for(int i=0;i<x;i++ ){
                            objects.Transaction trans=ar.get(i);
